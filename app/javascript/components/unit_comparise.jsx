      ...
      <form onSubmit={handleSubmit} className={form__compare}>
        <div className={form__div_0}>
          <div className={form__div_1}>
            ...
            <div>
              <label className={form__label}>{t('description.quantity')} {t('description.units')} {t('description.in_unit')} {t('description.one')}</label>
              <input
                type="text"
                name="quantity1"
          ...
          <div className={form__div_1}>
            ...
            <div>
              <label className={form__label}>{t('description.quantity')} {t('description.units')} {t('description.in_unit')} {t('description.two')}</label>
              <input
                type="text"
                name="quantity2"
      ...
      {result && (
        <div className={result__div_0}>
          <div className={result__div_1}>
            ...
            <p>{t('description.price')} {t('description.per_unit')} {t('description.product')} {t('description.one')}{t('description.two_point')}  <span className={results_span}>{result.unit_price1}</span>  {t('description.currency')}</p>
            <p>{t('description.price')} {t('description.per_unit')} {t('description.product')} {t('description.two')}{t('description.two_point')}  <span className={results_span}>{result.unit_price2}</span>  {t('description.currency')}</p>
            ...
            <div className={`${results_condition_main} ${result.better_option === 'equal'
              ...
              {result.better_option === 'equal' ? (
                ...
                <>                  
                  ...
                  <p>{t('description.econom')} {result.savings} {t('description.currency')} {t('description.per_unit')}</p>
                </>
              )}</div>
