...
import { elementDiv0Class } from "./classes"; // Импортируем классы
...
const ElementWeight = ({ t }) => {
  ...
  return (
    <div className={elementDiv0Class}>
      <NavLink 
        to="/weight_comparison" 
        className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9 flex flex-col items-center text-center block hover:text-indigo-600"
      >
        <div className="mb-7">
          {massIcon}
        </div>
